...
public abstract class KylinAuthorizationProvider {
    ...
    public static KylinAuthorizationProvider getInstance(KylinConfig config) {
        ...
        synchronized (KylinAuthorizationProvider.class) {
            ...
            authorizer = (KylinAuthorizationProvider) ClassUtil.newInstance(config.getAuthorizationProvider());
            authorizer.init();
    ...
    public abstract boolean checkPermission(String projectName, String cubeName, String user, List<String> userAuthorities, String permissions);
}
